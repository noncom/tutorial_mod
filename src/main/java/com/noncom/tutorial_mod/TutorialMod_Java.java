...
import com.noncom.tutorial_mod.setup.IWorldProxy;
...
//@Mod("tutorial_mod")
public class TutorialMod_Java {
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();

    IWorldProxy worldProxy = DistExecutor.runForDist(() -> () -> new ClientWorldProxy(), () -> () -> new ServerWorldProxy());

    public TutorialMod_Java() {
    ...
    private void enqueueIMC(final InterModEnqueueEvent event) {
        ...
        InterModComms.sendTo("tutorial_mod", "helloworld", () -> {
